                ...
                <div class="container-fluid" style="margin:auto;">
                        ...
                        <form id="contactForm">
                            ...
                            <div class="row input-group-newsletter">
                                <div class="col"><input class="form-control" id="text" type="text" placeholder="Name" aria-label="Enter name here..."/></div>
                            </div>
                            <br>
                            <div class="row input-group-newsletter">
                                <div class="col"><input class="form-control" id="username" type="username" placeholder="Username" aria-label="Enter name here..."/></div>
                            </div>
                            <br>
                            <div class="row input-group-newsletter">
                                <div class="col"><input class="form-control" id="email" type="email" placeholder="Email" aria-label="Enter email address..." data-sb-validations="required,email" /></div>
                            </div>
                            <br>
                            <div class="row input-group-newsletter">
