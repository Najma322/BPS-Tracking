                ...
                <ul>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                            <li><a class="dropdown-item" href="/login">SAKERNAS 2023</a></li>
                            <li><a class="dropdown-item" href="#">Program Lainnya</a></li>
                    ...
                    <!-- <ul class="navbar-nav">
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                          <li><a class="dropdown-item" href="/login">Program</a></li>
                          <li><a class="dropdown-item" href="#">Program Lainnya</a></li>
                          <li><a class="dropdown-item" href="#">Something else here</a></li>
                        </ul>
                      </li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 pt-6 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <center>
                        <h1 class="fst-italic" style="font-size: 45px; color: #1C256A;"><b>BADAN PUSAT STATISTIK</b></h1>
                        <h1 class="fst-italic" style="font-size: 45px; color: #1C256A;"><b>KABUPATEN PASURUAN</b></h1>
                    </center>
                    <br>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
                    <img src="./bps_resources/img/logo badan pusat statistik.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
    </section>
